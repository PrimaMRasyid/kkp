                        ...
                        <dl class="dl-horizontal">
                          ...
                          <dd>{!! $form->sender_address !!}</dd>
                           ...
                           <dd>{!! $form->jenis_komoditas !!}</dd>
                            ...
                            <dt></dt>
                            <dd>{!! auth()->user()->isUserlab() ? '<a href="'.route('lab.paid', ['id' => $form->id]).'" class="btn btn-sm btn-success">Set Paid</a>' : '' !!}<a href="{!! route('pabean.home') !!}" class="btn btn-sm btn-default pull-right" style="margin-right: 10px">Go Back</a>
                            </dd>
                        </dl>
                    </div>
                </div>
